...
const examples: Array<Example | { isSeparator: boolean }> = [
  ...
  },
  {
    ...
    icon: Layers,
    color: "text-teal-500",
    href: "/examples/clustering" as Href,
  },
  {
    id: "choropleth",
    title: "Choropleth + Legend",
    description: "Color regions by value with a synced legend",
    icon: BarChart3Icon,
    color: "text-fuchsia-500",
    href: "/examples/choropleth" as Href,
  },
  {
    id: "circle",
    title: "Search Radius",
    description: "Draggable-radius circle for search areas",
    icon: MapPin,
    color: "text-lime-500",
    href: "/examples/circle" as Href,
  },
  {
    id: "polygon",
    title: "Service Area",
    ...
    icon: Layers,
    color: "text-cyan-600",
    href: "/examples/polygon" as Href,
  },
  {
    id: "style-switcher",
    title: "Style Switcher",
    description: "Cycle through the provider's named map styles",
    icon: Settings,
    color: "text-slate-500",
    href: "/examples/style-switcher" as Href,
  },
];
        ...
        <View className="px-6 py-8 w-full gap-8">
          ...
          <View className="p-6 bg-muted/30 rounded-lg border border-border mt-4">
            ...
            <Text className="text-sm text-muted-foreground">
              ...
              @maplibre/maplibre-react-native v11. Scan the QR code from the
