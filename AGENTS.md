...
This is a React Native mobile application built with Expo SDK 54, using file-based routing via Expo Router. The app features MapLibre-based map integration with location services and uses NativeWind (Tailwind CSS) for styling.
